...
const NEW_PAGES = [
  ...
  },
  {
    ...
    body: body({
      overview: [
        'OMS·WMS·Admin 프론트엔드 전 영역을 맡고, React Native 로 현장 PDA 앱까지 직접 만들었습니다. 추가 채용 없이 프론트 전 영역을 기한 내 커버했고, 배포 원복 시간을 50% 줄였습니다.',
        'OMS·FE 파트를 리딩했습니다.',
      ],
      problem: [
      ...
      results: [
        '주소록 자동 완성에서 동작하지 않던 전체 목록 조회를 걷어내 페이지 멈춤 현상을 제거.',

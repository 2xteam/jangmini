...
import { TodosTab } from '@/app/admin/todos-tab';

/**
 * 관리 콘솔. 탭 여섯 — 채울 자리 · 사용량 · 콘텐츠 · 설정 · 계정 · 추천질문.
 *
...
type Tab = 'todos' | 'usage' | 'content' | 'settings' | 'readers' | 'answers';

const TABS: { id: Tab; label: string }[] = [
  /** 맨 앞에 둔다 — 열자마자 할 일이 보여야 실제로 처리된다 */
  { id: 'todos', label: '채울 자리' },
  { id: 'usage', label: '사용량' },
